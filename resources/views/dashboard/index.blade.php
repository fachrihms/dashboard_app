                ...
                <li class="nav-item dropdown language-dropdown"> <!-- Bendera Bahasa -->
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="./src/assets/img/1x1/id.svg" class="flag-width" alt="flag"> <span
                                class="align-self-center">&nbsp;Indonesia</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="./src/assets/img/1x1/sa.webp" class="flag-width" alt="flag"> <span
                                class="align-self-center">&nbsp;Arab</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
