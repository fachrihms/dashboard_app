...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="./src/assets/img/favicon-96x96.png" />
        ...
        <div class="col-6 d-lg-flex d-none h-100 my-auto top-0 start-0 text-center justify-content-center flex-column">
          ...
          <div class="auth-cover">
            ...
            <div class="position-relative">
              ...
              <p class="text-white px-2">Fundamental Intelegent</p>
            </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="mb-4">
                    <button class="btn btn-secondary w-100" onclick="location.href = './menu.html'">SIGN IN</button>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="text-center">
                    <p class="mb-0">Dont't have an account ? <a href="auth-cover-signup.html" class="text-warning">Sign
                        Up</a></p>
                  </div>
                </div>
